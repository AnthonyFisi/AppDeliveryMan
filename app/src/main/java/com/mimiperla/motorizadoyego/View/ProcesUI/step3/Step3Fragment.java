...
import com.mimiperla.motorizadoyego.View.ProcesUI.step4.Step4Activity;
import com.mimiperla.motorizadoyego.ViewModel.Orden_estado_deliveryViewModel;
import com.mimiperla.motorizadoyego.ViewModel.ProductoJOINregistroPedidoJOINpedidoViewModel;
...
public class Step3Fragment extends Fragment implements ProductosResultsAdapter.ClickPedidoDetalle {
    ...
    private void setDataWidget() {
        ...
        if (mGsonDelivery_pedido != null) {
            ...
            String day = "1"; // "Tuesday"

            //(new SimpleDateFormat("EEEE")).format(mDelivery_pedido.getVenta_fechaentrega().getTime());

            String month = "2";
            //(new SimpleDateFormat("MMMM")).format(mDelivery_pedido.getVenta_fechaentrega().getTime()); // "April"

            String year = "2022";
            //(new SimpleDateFormat("yyyy")).format(mDelivery_pedido.getVenta_fechaentrega().getTime()); // "April"

            int numberDay = 2;
            //mDelivery_pedido.getVenta_fechaentrega().getDate();
