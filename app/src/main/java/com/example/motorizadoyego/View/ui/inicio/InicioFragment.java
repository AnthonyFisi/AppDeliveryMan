package com.example.motorizadoyego.View.ui.inicio;
...
import com.example.motorizadoyego.View.ProcesUI.step5.Step5Fragment;
import com.example.motorizadoyego.View.ProcesUI.step6.Step6Fragment;
import com.example.motorizadoyego.View.ProcesUI.StepPictureFragment;
...
import com.example.motorizadoyego.View.ProcesUI.step1.Step1Fragment;
import com.example.motorizadoyego.View.ProcesUI.step2.Step2Fragment;
...
import com.example.motorizadoyego.View.ui.tools.ToolsFragment;
                ...
                getActivity().runOnUiThread(() -> {
                    try {
                       ...
                       /* fragment_home_button_ESTADO_REPARTIDOR.setVisibility(View.GONE);
                        ...
                        fragment_home_linear_desactivado.setVisibility(View.GONE);
*/
                       // drawRouteStep1Fragment();

                        //stopLocationUpdates();

                        mGsonDeliveryPedido.getListaDeliveryPedido().add(mGsonDelivery_pedido.getDelivery_information());
                        refreshViewPedido();
...
/*
    ...
    private void refreshViewPedido(){
        ...
        if(mGsonDeliveryPedido.getListaDeliveryPedido().size()==1){
            total_pedido=mGsonDeliveryPedido.getListaDeliveryPedido().size()+" pedido";

        }else {
            total_pedido=mGsonDeliveryPedido.getListaDeliveryPedido().size()+" pedidos";
        }
    ...
    private void deletePedidoFinish(Delivery_Pedido delivery_pedido){
        ...
        for(Delivery_Pedido pedido:mGsonDeliveryPedido.getListaDeliveryPedido()){
        ...
        mGsonDeliveryPedido.getListaDeliveryPedido().remove(position);
